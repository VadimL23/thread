...
status_str db 'I',str_c,'D',str_c, ' '
           db  str_c,' ',str_c,'ª',str_c,'β',str_c,'¨',str_c,'Ά',str_c,'­',str_c
           db '®',str_c,'£',str_c,'®',str_c,' ',str_c,'―',str_c,'®',str_c
           db 'β',str_c,'®',str_c,'ª',str_c,' ',str_c,':',str_c,' ',str_c, ' ',str_c,' ',str_c     ;46
